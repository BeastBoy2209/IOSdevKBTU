...
#ifndef ASSIGNMENT5_SWIFT_H
#define ASSIGNMENT5_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Assignment5",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Assignment511AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC11Assignment513SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC11Assignment514ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified background;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified rouletteWheel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified spinButton;
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified betAmountField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified betNumberField;
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified betTypeSegment;
- (void)viewDidLoad;
- (IBAction)spinButtonTapped:(UIButton * _Nonnull)sender;
